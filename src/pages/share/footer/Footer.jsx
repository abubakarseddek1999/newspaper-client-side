    ...
    return (
        <div>
            ...
            <footer className="footer p-10 bg-neutral text-neutral-content">
                <aside>
                    <img className="w-[50px] h-[50px] rounded-full" src="https://i.postimg.cc/ZK64GFyn/letter-n-logo-design-for-business-and-company-identity-with-luxury-concept-free-vector.jpg" alt="" />
                    <p>NewsBD<br />Providing reliable tech since 1992</p>
                </aside>
